...
def scihub_download_pdf(paper: dict, output_folder: str = "/input/pdf") -> None:
    """
    Downloads a PDF of an article using the provided 'title' and 'link' fields from a dictionary,
    and saves it to the specified output folder with title as name.
